...
public abstract class PaymentEventProducerService<T extends PaymentEvent> extends KafkaProducerService<T> {

    public PaymentEventProducerService(KafkaTemplate<String, String> kafkaTemplate) {
        super(kafkaTemplate);
    }
